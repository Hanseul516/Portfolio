  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          className="bg-white p-4 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer border border-black/10  dark:bg-white/10"
        ...
        >
          <svg
            ...
            className="w-5 h-5 fill-gray-700 hover:fill-gray-950 dark:fill-white/60"
          >
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10 dark:bg-white/10 dark:text-white/60"
