...
export const projectsData = [
  {
    ...
    moreDescription: "React-Responsive 모듈을 사용하여 전 화면을 반응형으로 설계했습니다. 그리고 React-Slick 라이브러리를 사용하여 메인페이지의 도서 슬라이더를 구현했습니다.",
  ...
  },
  {
    ...
    moreDescription: "Tailwind CSS를 사용하여 모던한 UI를 구현하고자 했습니다. 더불어 Framer Motion 라이브러리를 사용해 다양한 애니메이션 효과를 부여했습니다. 또한 Vercel을 이용한 배포를 경험할 수 있었습니다.",
